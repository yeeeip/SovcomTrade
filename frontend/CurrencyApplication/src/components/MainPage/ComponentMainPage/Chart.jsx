		...
		<ChartDiv>
			{isActive && (
				<>
					<ButtonTitleDiv>
						<ButtonDiv>
							<ButtonDirhamsActive href='#' onClick={handleButtonOption}>
								Дирхам
							</ButtonDirhamsActive>
							<ButtonYuanActive href='#' onClick={handleButtonOption}>
								Юань
							</ButtonYuanActive>
						</ButtonDiv>
			...
			{!isActive && (
				<>
					<ButtonTitleDiv>
						<ButtonDiv>
							<ButtonDirhams href='#' onClick={handleButtonOption}>
								Дирхам
							</ButtonDirhams>
							<ButtonYuan href='#' onClick={handleButtonOption}>
								Юань
							</ButtonYuan>
						</ButtonDiv>
						<ChartTitle>Курсы по отношению к рублю</ChartTitle>
